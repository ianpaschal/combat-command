...
/**
 * Returns the total number of units lost by a given user within a set of match results.
 *
 * @param matchResults - The array of match results to include in the calculation
 * @param userId - The user UUID
 * @returns The total number of units lost
 */
export const getTotalUnitsLostByUser = (matchResults: Match[], userId: string): number => (
