...
import { useGetTournamentCompetitor } from '~/services/tournamentCompetitors/useGetTournamentCompetitor';
...
export const PairableCompetitorCard = forwardRef<PairableCompetitorCardRef, PairableCompetitorCardProps>(({
  ...
  const { data: competitor, loading } = useGetTournamentCompetitor(competitorId);
  return (
