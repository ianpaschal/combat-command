...
export const AlignmentGraph = ({
  ...
  const { data: tournamentRegistrations } = useGetTournamentRegistrationsByTournament({
  ...
  return (
    <div className={clsx(styles.AlignmentGraph, className)}>
      <h3 className={styles.AlignmentGraph_AnchorLeft}>Allies</h3>
      <ChevronDown className={styles.AlignmentGraph_CenterMark} absoluteStrokeWidth strokeWidth={3} />
      <h3 className={styles.AlignmentGraph_AnchorRight}>Axis</h3>
