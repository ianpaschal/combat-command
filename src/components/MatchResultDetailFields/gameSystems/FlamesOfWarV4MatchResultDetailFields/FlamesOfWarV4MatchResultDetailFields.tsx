...
import { getBattlePlanOptions, getFactionOptions } from '@ianpaschal/combat-command-game-systems/flamesOfWarV4';
...
} from './FlamesOfWarV4MatchResultDetailFields.hooks';

import styles from './FlamesOfWarV4MatchResultDetailFields.module.scss';
...
export const FlamesOfWarV4MatchResultDetailFields = ({
  ...
  return (
    <div className={clsx(styles.FlamesOfWarV4MatchResultDetailFields, className)}>
      ...
      <div className={styles.FlamesOfWarV4MatchResultDetailFields_SharedSection}>
        ...
        <div className={styles.FlamesOfWarV4MatchResultDetailFields_SharedSection_Outcome}>
        ...
        {showScoreOverride && (
          <div className={styles.FlamesOfWarV4MatchResultDetailFields_SharedSection_ScoreOverride}>
            {([0, 1] as const).map((i) => (
              <FormField
