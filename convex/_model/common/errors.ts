export const errors = {
  ...
  CLAIM_TOKEN_INVALID: 'Invalid claim token.',
  ...
  // Friendships
  CANNOT_REQUEST_FRIENDSHIP_AS_OTHER_USER: 'Cannot request a friendship as another user.',
  CANNOT_CREATE_CIRCULAR_FRIENDSHIP: 'Friendship sender and recipient must be different users.',
